...
void loop(){
	...
	int speedVal1 = map(pulseNum1, 1900, 1100, -255, 255); // up/down
	int speedVal2 = map(pulseNum2, 1900, 1100, -255, 255); // go/back
	int speedVal3 = map(pulseNum3, 1900, 1100, -255, 255); // left/right
