...
void setup(){
    ...
    pinMode(outPin4, OUTPUT); // outPin4: magnet
	//--------------------------------------------
...
void loop(){
    ...
    // magnet 
	//--------------------------------------------
    if (pulseNum4 < 1500) digitalWrite(outPin4, HIGH);
    else if(pulseNum4 >1500) digitalWrite(outPin4, LOW);
	//--------------------------------------------
	//--------------------------------------------
